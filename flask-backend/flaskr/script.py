...
def insert_json_into_db():
    ...
    for item in data:
        ...
        update_db("INSERT INTO restaurants (id, business_name, business_address, business_city, postal_code, stars, review_count, attributes, categories, business_hours) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                    (id, business_name, business_address, business_city, postal_code, stars, review_count, attributes, categories, business_hours))
        count = count + 1
